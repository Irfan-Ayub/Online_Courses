...
public class Target : IComparable
{
    ...
    public int CompareTo(object obj)
    {
        ...
        GameObject otherTarget = obj as GameObject;
        Target otherTargetScript = otherTarget.GetComponent<Target>();

        if(otherTargetScript != null)
        {
            if (this.distance < otherTargetScript.Distance)
                return -1;
