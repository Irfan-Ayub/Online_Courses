...
public class CharacterController2D : MonoBehaviour {
	...
	void Update()
	{
        ...
        else if(canDoubleJump && CrossPlatformInputManager.GetButtonDown("Jump")) // if candoublejump and jump is pressed than allow player to jump second time
        {
            DoJump();

            // disable double jump sice you can double jump only one time
            canDoubleJump  = false;
        }
